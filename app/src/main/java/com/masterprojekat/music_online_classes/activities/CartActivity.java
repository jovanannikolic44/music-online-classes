...
import com.masterprojekat.music_online_classes.adapters.CartAdapter;
...
public class CartActivity extends AppCompatActivity {
    ...
    private void buyCourses() {
        ...
        if (selectedCourses.isEmpty()) {
            Toast.makeText(CartActivity.this, "Niste izabrali nijedan kurs.", Toast.LENGTH_SHORT).show();
            return;
        }
