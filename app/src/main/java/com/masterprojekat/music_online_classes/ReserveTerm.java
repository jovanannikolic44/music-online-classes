...
public class ReserveTerm extends AppCompatActivity {
        ...
        termApi.getAllAvailableTermsForProfessor(courseToReserve.getProfessor().getUsername()).enqueue(new Callback<List<Term>>() {
            ...
            public void onResponse(@NonNull Call<List<Term>> call, @NonNull Response<List<Term>> response) {
                if(response.isSuccessful() && response.body() != null) {
                    ...
                    ArrayAdapter<Term> adapter = new ArrayAdapter<>(ReserveTerm.this, android.R.layout.simple_spinner_item, availableTerms);
                    ...
                    reserveTermButton.setOnClickListener(view -> {
                        if (selectedTerm != null) {
                            ...
                            Toast.makeText(ReserveTerm.this, "Niste izabrali ni jedan termin!", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else {
                    Toast.makeText(ReserveTerm.this, "Greska pri dohvatanju slobodnih termina!", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(@NonNull Call<List<Term>> call, @NonNull Throwable throwable) {
                Logger.getLogger(ReserveTerm.class.getName()).log(Level.SEVERE, "Greska! Zahtev za dohvatanjem slobodnih termina nije uspeo!", throwable);
            }
        });
    }
        ...
        termApi.requestTerm(selectedTerm.getTermId(), loggedInUser.getUsername(), courseToReserve.getCourseId()).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                if(response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(ReserveTerm.this, message, Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Call<ResponseBody> call, @NonNull Throwable throwable) {
                Logger.getLogger(ReserveTerm.class.getName()).log(Level.SEVERE, "Greska! Zahtev za rezervaciju termina nije uspeo!", throwable);
            }
        });
    }
