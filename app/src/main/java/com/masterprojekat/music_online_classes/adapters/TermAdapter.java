...
import com.masterprojekat.music_online_classes.activities.VideoCallActivity;
...
public class TermAdapter extends RecyclerView.Adapter<TermAdapter.TermViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TermViewHolder holder, int position) {
        ...
        holder.videoCallButton.setOnClickListener(v -> {
            Intent videoCallIntent = new Intent(holder.itemView.getContext(), VideoCallActivity.class);
